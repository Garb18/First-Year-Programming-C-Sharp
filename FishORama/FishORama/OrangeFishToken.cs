 ...
 * and adding features not directly available in Microsoft.Xna.
...
namespace FishORama
{
    ...
    class OrangeFishToken: X2DToken
    {
        ...
        protected override void DefaultProperties() {
            ...
            OrangeFishMind myMind = new OrangeFishMind(this);   // Create mind, implicitly associating it to the token.
